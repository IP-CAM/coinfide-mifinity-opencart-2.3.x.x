        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-mifinity" class="form-horizontal">
         <!-- <div class="form-group">
          ...
          <div class="form-group required">
            ...
            <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-account-holder-id">
                    <span data-toggle="tooltip"
                          title="<?php echo $help_account_holder_id; ?>"><?php echo $entry_account_holder_id; ?></span>
                </label>
                <div class="col-sm-10">
                    <input type="text" name="mifinity_account_holder_id" value="<?php echo $mifinity_account_holder_id; ?>"
                           placeholder="<?php echo $entry_account_holder_id; ?>" id="input-account-holder-id" class="form-control"/>
                    <?php if ($error_account_holder_id) { ?>
                    <div class="text-danger"><?php echo $error_account_holder_id; ?></div>
                    <?php } ?>
                </div>
            </div>
            <div class="form-group required">
